...
void config_rdma_global_csr (struct rdma_dev_t* rdma_dev) {
  ...
  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_DATBUFBA(rdma_dev->engine_id), data_buf_baseaddr_lsb);
  Debug("[Register] RN_RDMA_GCSR_DATBUFBA=0x%x, value=0x%x\n", RN_RDMA_GCSR_DATBUFBA(rdma_dev->engine_id), data_buf_baseaddr_lsb);
  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_DATBUFBAMSB(rdma_dev->engine_id), data_buf_baseaddr_msb);
  Debug("[Register] RN_RDMA_GCSR_DATBUFBAMSB=0x%x, value=0x%x\n", RN_RDMA_GCSR_DATBUFBAMSB(rdma_dev->engine_id), data_buf_baseaddr_msb);
  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_DATBUFSZ(rdma_dev->engine_id), global_csr->data_buf_size);
  Debug("[Register] RN_RDMA_GCSR_DATBUFSZ=0x%x, value=0x%x\n", RN_RDMA_GCSR_DATBUFSZ(rdma_dev->engine_id), global_csr->data_buf_size);

  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_IPKTERRQBA(rdma_dev->engine_id), ipkt_err_stat_q_baseaddr_lsb);
  Debug("[Register] RN_RDMA_GCSR_IPKTERRQBA=0x%x, value=0x%x\n", RN_RDMA_GCSR_IPKTERRQBA(rdma_dev->engine_id), ipkt_err_stat_q_baseaddr_lsb);
  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_IPKTERRQBAMSB(rdma_dev->engine_id), ipkt_err_stat_q_baseaddr_msb);
  Debug("[Register] RN_RDMA_GCSR_IPKTERRQBAMSB=0x%x, value=0x%x\n", RN_RDMA_GCSR_IPKTERRQBAMSB(rdma_dev->engine_id), ipkt_err_stat_q_baseaddr_msb);
  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_IPKTERRQSZ(rdma_dev->engine_id), ipkt_err_stat_q_size);
  Debug("[Register] RN_RDMA_GCSR_ERRBUFSZ=0x%x, value=0x%x\n", RN_RDMA_GCSR_IPKTERRQSZ(rdma_dev->engine_id), ipkt_err_stat_q_size);

  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_ERRBUFBA(rdma_dev->engine_id), err_buf_baseaddr_lsb);
  Debug("[Register] RN_RDMA_GCSR_ERRBUFBA=0x%x, value=0x%x\n", RN_RDMA_GCSR_ERRBUFBA(rdma_dev->engine_id), err_buf_baseaddr_lsb);
  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_ERRBUFBAMSB(rdma_dev->engine_id), err_buf_baseaddr_msb);
  Debug("[Register] RN_RDMA_GCSR_ERRBUFBAMSB=0x%x, value=0x%x\n", RN_RDMA_GCSR_ERRBUFBAMSB(rdma_dev->engine_id), err_buf_baseaddr_msb);
  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_ERRBUFSZ(rdma_dev->engine_id), global_csr->err_buf_size);
  Debug("[Register] RN_RDMA_GCSR_ERRBUFSZ=0x%x, value=0x%x\n", RN_RDMA_GCSR_ERRBUFSZ(rdma_dev->engine_id), global_csr->err_buf_size);

  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_RESPERRPKTBA(rdma_dev->engine_id), resp_err_pkt_buf_baseaddr_lsb);
  Debug("[Register] RN_RDMA_GCSR_RESPERRPKTBA=0x%x, value=0x%x\n", RN_RDMA_GCSR_RESPERRPKTBA(rdma_dev->engine_id), resp_err_pkt_buf_baseaddr_lsb);
  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_RESPERRPKTBAMSB(rdma_dev->engine_id), resp_err_pkt_buf_baseaddr_msb);
  Debug("[Register] RN_RDMA_GCSR_RESPERRPKTBAMSB=0x%x, value=0x%x\n", RN_RDMA_GCSR_RESPERRPKTBAMSB(rdma_dev->engine_id), resp_err_pkt_buf_baseaddr_msb);
  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_RESPERRSZ(rdma_dev->engine_id), resp_err_pkt_buf_size);
  Debug("[Register] RN_RDMA_GCSR_RESPERRSZ=0x%x, value=0x%x\n", RN_RDMA_GCSR_RESPERRSZ(rdma_dev->engine_id), resp_err_pkt_buf_size);
  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_RESPERRWRPTR(rdma_dev->engine_id), resp_err_pkt_buf_cur_ptr);
  Debug("[Register] RN_RDMA_GCSR_RESPERRWRPTR=0x%x, value=0x%x\n", RN_RDMA_GCSR_RESPERRWRPTR(rdma_dev->engine_id), resp_err_pkt_buf_cur_ptr);
  ...
  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_INTEN(rdma_dev->engine_id), global_csr->interrupt_enable);
  Debug("[Register] RN_RDMA_GCSR_INTEN=0x%x, value=0x%x\n", RN_RDMA_GCSR_INTEN(rdma_dev->engine_id), global_csr->interrupt_enable);

  // configure local MAC address
  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_MACXADDLSB(rdma_dev->engine_id), global_csr->src_mac.mac_lsb);
  Debug("[Register] RN_RDMA_GCSR_MACXADDLSB=0x%x, value=0x%x\n", RN_RDMA_GCSR_MACXADDLSB(rdma_dev->engine_id), global_csr->src_mac.mac_lsb);
  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_MACXADDMSB(rdma_dev->engine_id), global_csr->src_mac.mac_msb);
  Debug("[Register] RN_RDMA_GCSR_MACXADDMSB=0x%x, value=0x%x\n", RN_RDMA_GCSR_MACXADDMSB(rdma_dev->engine_id), global_csr->src_mac.mac_msb);

  // configure local IPv4 address
  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_IPV4XADD(rdma_dev->engine_id), global_csr->src_ip);
  Debug("[Register] RN_RDMA_GCSR_IPV4XADD=0x%x, value=0x%x\n", RN_RDMA_GCSR_IPV4XADD(rdma_dev->engine_id), global_csr->src_ip);

  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_XRNICCONF(rdma_dev->engine_id), global_csr->xrnic_conf);
  Debug("[Register] RN_RDMA_GCSR_XRNICCONF=0x%x, value=0x%x\n", RN_RDMA_GCSR_XRNICCONF(rdma_dev->engine_id), global_csr->xrnic_conf);

  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_XRNICADCONF(rdma_dev->engine_id), global_csr->xrnic_advanced_conf);
  Debug("[Register] RN_RDMA_GCSR_XRNICADCONF=0x%x, value=0x%x\n", RN_RDMA_GCSR_XRNICADCONF(rdma_dev->engine_id), global_csr->xrnic_advanced_conf);

  write32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_XRNIC_CONF_QP_EN(rdma_dev->engine_id), global_csr->xrnic_conf_qp_en);
  Debug("[Register] RN_RDMA_GCSR_XRNIC_CONF_QP_EN=0x%x, value=0x%x\n", RN_RDMA_GCSR_XRNIC_CONF_QP_EN(rdma_dev->engine_id), global_csr->xrnic_conf_qp_en);
...
struct rdma_pd_t* allocate_rdma_pd(struct rdma_dev_t* rdma_dev, uint32_t pd_num) {
  ...
  if(rdma_dev != NULL) {
    ...
    write32_data(rdma_dev->axil_ctl, get_rdma_pd_config_addr(RN_RDMA_PDT_PDPDNUM(rdma_dev->engine_id), pd_num), pd_num);
    Debug("[Register] RN_RDMA_PDT_PDPDNUM=0x%x, pd_num=%d, value=0x%x\n", get_rdma_pd_config_addr(RN_RDMA_PDT_PDPDNUM(rdma_dev->engine_id), pd_num), pd_num, pd_num);
...
void rdma_register_memory_region(struct rdma_dev_t* rdma_dev, struct rdma_pd_t* rdma_pd, uint32_t r_key, struct rdma_buff_t* rdma_buf) {
  ...
  write32_data(rdma_dev->axil_ctl, get_rdma_pd_config_addr(RN_RDMA_PDT_VIRTADDRLSB(rdma_dev->engine_id), pd_num), rdma_pd->virtual_addr_lsb);
  Debug("[Register] RN_RDMA_PDT_VIRTADDRLSB=0x%x, pd_num=%d, value=0x%x\n", get_rdma_pd_config_addr(RN_RDMA_PDT_VIRTADDRLSB(rdma_dev->engine_id), pd_num), pd_num, rdma_pd->virtual_addr_lsb);
  write32_data(rdma_dev->axil_ctl, get_rdma_pd_config_addr(RN_RDMA_PDT_VIRTADDRMSB(rdma_dev->engine_id), pd_num), rdma_pd->virtual_addr_msb);
  Debug("[Register] RN_RDMA_PDT_VIRTADDRMSB=0x%x, pd_num=%d, value=0x%x\n", get_rdma_pd_config_addr(RN_RDMA_PDT_VIRTADDRMSB(rdma_dev->engine_id), pd_num), pd_num, rdma_pd->virtual_addr_msb);
  write32_data(rdma_dev->axil_ctl, get_rdma_pd_config_addr(RN_RDMA_PDT_BUFBASEADDRLSB(rdma_dev->engine_id), pd_num), rdma_pd->dma_addr_lsb);
  Debug("[Register] RN_RDMA_PDT_BUFBASEADDRLSB=0x%x, pd_num=%d, value=0x%x\n", get_rdma_pd_config_addr(RN_RDMA_PDT_BUFBASEADDRLSB(rdma_dev->engine_id), pd_num), pd_num, rdma_pd->dma_addr_lsb);
  write32_data(rdma_dev->axil_ctl, get_rdma_pd_config_addr(RN_RDMA_PDT_BUFBASEADDRMSB(rdma_dev->engine_id), pd_num), rdma_pd->dma_addr_msb);
  Debug("[Register] RN_RDMA_PDT_BUFBASEADDRMSB=0x%x, pd_num=%d, value=0x%x\n", get_rdma_pd_config_addr(RN_RDMA_PDT_BUFBASEADDRMSB(rdma_dev->engine_id), pd_num), pd_num, rdma_pd->dma_addr_msb);
  write32_data(rdma_dev->axil_ctl, get_rdma_pd_config_addr(RN_RDMA_PDT_BUFRKEY(rdma_dev->engine_id), pd_num), r_key);
  Debug("[Register] RN_RDMA_PDT_BUFRKEY=0x%x, pd_num=%d, value=0x%x\n", get_rdma_pd_config_addr(RN_RDMA_PDT_BUFRKEY(rdma_dev->engine_id), pd_num), pd_num, r_key);

  write32_data(rdma_dev->axil_ctl, get_rdma_pd_config_addr(RN_RDMA_PDT_WRRDBUFLEN(rdma_dev->engine_id), pd_num), buffer_size);
  Debug("[Register] RN_RDMA_PDT_WRRDBUFLEN=0x%x, pd_num=%d, value=0x%lx B\n", get_rdma_pd_config_addr(RN_RDMA_PDT_WRRDBUFLEN(rdma_dev->engine_id), pd_num), pd_num, buffer_size);
  access_config = ((rdma_pd->buffer_size_msb<<16) | rdma_pd->pd_access_type);
  write32_data(rdma_dev->axil_ctl, get_rdma_pd_config_addr(RN_RDMA_PDT_ACCESSDESC(rdma_dev->engine_id), pd_num), access_config);
  Debug("[Register] RN_RDMA_PDT_ACCESSDESC=0x%x, pd_num=%d, value=0x%x\n", get_rdma_pd_config_addr(RN_RDMA_PDT_ACCESSDESC(rdma_dev->engine_id), pd_num), pd_num, access_config);
...
void config_last_rq_psn(struct rdma_dev_t* rdma_dev, uint32_t qpid, uint32_t last_rq_psn)
{
  ...
  write32_data(rdma_dev->axil_ctl,
              get_rdma_per_q_config_addr(RN_RDMA_QCSR_LSTRQREQi(rdma_dev->engine_id), qpid),
              rq_conf);
...
void config_sq_psn(struct rdma_dev_t* rdma_dev, uint32_t qpid, uint32_t sq_psn){
  write32_data(rdma_dev->axil_ctl,
              get_rdma_per_q_config_addr(RN_RDMA_QCSR_SQPSNi(rdma_dev->engine_id), qpid),
              sq_psn);
...
struct rdma_qp_t* allocate_rdma_qp(struct rdma_dev_t* rdma_dev,
  ...
  write32_data(rdma_dev->axil_ctl,
              get_rdma_per_q_config_addr(RN_RDMA_QCSR_IPDESADDR1i(rdma_dev->engine_id), qpid),
              dst_ip);
  Debug("[Register] RN_RDMA_QCSR_IPDESADDR1i=0x%x, qpid=%d, value=0x%x\n",
                    ...
                    dst_ip);
  write32_data(rdma_dev->axil_ctl,
                get_rdma_per_q_config_addr(RN_RDMA_QCSR_MACDESADDLSBi(rdma_dev->engine_id), qpid),
                dst_mac->mac_lsb);
  Debug("[Register] RN_RDMA_QCSR_MACDESADDLSBi=0x%x, qpid=%d, value=0x%x\n",
                    ...
                    dst_mac->mac_lsb);
  write32_data(rdma_dev->axil_ctl,
              get_rdma_per_q_config_addr(RN_RDMA_QCSR_MACDESADDMSBi(rdma_dev->engine_id), qpid),
              dst_mac->mac_msb);
  ...
  write32_data(rdma_dev->axil_ctl,
                get_rdma_per_q_config_addr(RN_RDMA_QCSR_SQBAi(rdma_dev->engine_id), qpid),
                sq_addr_lsb);
  Debug("[Register] RN_RDMA_QCSR_SQBAi=0x%x, qpid=%d, value=0x%x\n",
                  ...
                  sq_addr_lsb);
  write32_data(rdma_dev->axil_ctl,
                get_rdma_per_q_config_addr(RN_RDMA_QCSR_SQBAMSBi(rdma_dev->engine_id), qpid),
                sq_addr_msb);
  ...
  write32_data(rdma_dev->axil_ctl,
              get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQBAi(rdma_dev->engine_id), qpid),
              cq_addr_lsb);
  Debug("[Register] RN_RDMA_QCSR_CQBAi=0x%x, qpid=%d, value=0x%x\n",
                  ...
                  cq_addr_lsb);
  write32_data(rdma_dev->axil_ctl,
                get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQBAMSBi(rdma_dev->engine_id), qpid),
                cq_addr_msb);
  ...
  write32_data(rdma_dev->axil_ctl,
                get_rdma_per_q_config_addr(RN_RDMA_QCSR_RQBAi(rdma_dev->engine_id), qpid),
                rq_addr_lsb);
  Debug("[Register] RN_RDMA_QCSR_RQBAi=0x%x, qpid=%d, value=0x%x\n",
                    ...
                    rq_addr_lsb);
  write32_data(rdma_dev->axil_ctl,
                get_rdma_per_q_config_addr(RN_RDMA_QCSR_RQBAMSBi(rdma_dev->engine_id), qpid),
                rq_addr_msb);
  ...
  // CQ DB address
  write32_data(rdma_dev->axil_ctl,
              get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQDBADDi(rdma_dev->engine_id), qpid),
              cq_cidb_addr_lsb);
  Debug("[Register] RN_RDMA_QCSR_CQDBADDi=0x%x, qpid=%d, value=0x%x\n",
                    ...
                    cq_cidb_addr_lsb);
  write32_data(rdma_dev->axil_ctl,
                get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQDBADDMSBi(rdma_dev->engine_id), qpid),
                cq_cidb_addr_msb);
  ...
  // RQ DB address
  write32_data(rdma_dev->axil_ctl,
              get_rdma_per_q_config_addr(RN_RDMA_QCSR_RQWPTRDBADDi(rdma_dev->engine_id), qpid),
              rq_cidb_addr_lsb);
  Debug("[Register] RN_RDMA_QCSR_RQWPTRDBADDi=0x%x, qpid=%d, value=0x%x\n",
                    ...
                    rq_cidb_addr_lsb);
  write32_data(rdma_dev->axil_ctl,
              get_rdma_per_q_config_addr(RN_RDMA_QCSR_RQWPTRDBADDMSBi(rdma_dev->engine_id), qpid),
              rq_cidb_addr_msb);
  ...
  write32_data(rdma_dev->axil_ctl,
              get_rdma_per_q_config_addr(RN_RDMA_QCSR_DESTQPCONFi(rdma_dev->engine_id), qpid),
              dst_qpid);
  ...
  write32_data(rdma_dev->axil_ctl,
                get_rdma_per_q_config_addr(RN_RDMA_QCSR_QDEPTHi(rdma_dev->engine_id), qpid),
                (qdepth | qdepth << 16));
  ...
  write32_data(rdma_dev->axil_ctl,
                get_rdma_per_q_config_addr(RN_RDMA_QCSR_QPCONFi(rdma_dev->engine_id), qpid),
                qp_config);
  ...
  write32_data(rdma_dev->axil_ctl,
                get_rdma_per_q_config_addr(RN_RDMA_QCSR_QPADVCONFi(rdma_dev->engine_id), qpid),
                qp_adv_conf);
  ...
  write32_data(rdma_dev->axil_ctl,
                get_rdma_per_q_config_addr(RN_RDMA_QCSR_PDi(rdma_dev->engine_id), qpid),
                pd_entry->pd_num);
...
int poll_rq_pidb(struct rdma_dev_t* rdma_dev, uint32_t qpid) {
  ...
  int rq_pidb = read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATRQPIDBi(rdma_dev->engine_id), qpid));
  ...
  while(rq_pidb == qp->rq_pidb) {
      rq_pidb = read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATRQPIDBi(rdma_dev->engine_id), qpid));
  }
...
int poll_cq_cidb(struct rdma_dev_t* rdma_dev, uint32_t qpid, int sq_cidb) {
  ...
  cq_cidb = read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQHEADi(rdma_dev->engine_id), qpid));
  Debug("[Register] RN_RDMA_QCSR_CQHEADi=0x%x, qpid=%d, value=0x%x\n", get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQHEADi(rdma_dev->engine_id), qpid), qpid, cq_cidb);
...
int rdma_post_send(struct rdma_dev_t* rdma_dev, uint32_t qpid) {
  ...
  Debug("DEBUG: Reading hardware SQPIi (0x%x) = 0x%x\n", get_rdma_per_q_config_addr(RN_RDMA_QCSR_SQPIi(rdma_dev->engine_id), qpid), read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_SQPIi(rdma_dev->engine_id), qpid)));
  Debug("DEBUG: original qp->sq_pidb = 0x%x\n", qp->sq_pidb);

  qp->sq_pidb++;

  // Update sq_pidb to hardware
  write32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_SQPIi(rdma_dev->engine_id), qpid), qp->sq_pidb);
  Debug("[Register] RN_RDMA_QCSR_SQPIi=0x%x, qpid=%d, value=0x%x\n", get_rdma_per_q_config_addr(RN_RDMA_QCSR_SQPIi(rdma_dev->engine_id), qpid), qpid, qp->sq_pidb);
...
int rdma_post_batch_send(struct rdma_dev_t* rdma_dev, uint32_t qpid, uint32_t batch_size) {
  ...
  Debug("DEBUG: Update hardware sq db idx from software = %d\n", qp->sq_pidb);
  Debug("DEBUG: Reading hardware SQPIi (0x%x) = 0x%x\n", get_rdma_per_q_config_addr(RN_RDMA_QCSR_SQPIi(rdma_dev->engine_id), qpid), read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_SQPIi(rdma_dev->engine_id), qpid)));
  Debug("[Register] RN_RDMA_QCSR_CQHEADi=0x%x, qpid=%d, value=0x%x\n", get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQHEADi(rdma_dev->engine_id), qpid), qpid, qp->cq_cidb);
  // polling on completion, by checking CQ doorbell
...
void write_rq_cidb(struct rdma_dev_t* rdma_dev, struct rdma_qp_t* qp, uint32_t db_val) {
  ...
  // Writing to the card
  write32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_RQCIi(rdma_dev->engine_id), qp->qpid), db_val);
...
uint8_t rdma_release_rq_consumed (struct rdma_dev_t* rdma_dev, struct rdma_qp_t* qp) {
  ...
  rq_pidb = read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATRQPIDBi(rdma_dev->engine_id), qp->qpid));
  ...
  // write32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_RQCIi(rdma_dev->engine_id), qp->qpid), rq_pidb);
  Debug("[Register] RN_RDMA_QCSR_RQCIi=0x%x, qpid=%d, value=0x%x\n", get_rdma_per_q_config_addr(RN_RDMA_QCSR_RQCIi(rdma_dev->engine_id), qp->qpid), qp->qpid, rq_pidb);
...
void rdma_qp_fatal_recovery(struct rdma_dev_t* rdma_dev, uint32_t qpid) {
  ...
  while(1) {
    rt_value = read32_data(rdma_dev->axil_ctl,
                           get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATQPi(rdma_dev->engine_id), qpid));
  ...
  timeout_cnt = 0;
  while(read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQHEADi(rdma_dev->engine_id), qpid))
        != read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_SQPIi(rdma_dev->engine_id), qpid))) {
    timeout_cnt += 1;
    if (timeout_cnt > 100000){
      fprintf(stderr, "TIMEOUT: CQHEADi:0x%x and SQPIi:0x%x are different\n",
                      read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQHEADi(rdma_dev->engine_id), qpid)),
                      read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_SQPIi(rdma_dev->engine_id), qpid)));
      exit(EXIT_FAILURE);
    }
  }
  ...
  /* Disable the QP */
  rt_value = read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_QPCONFi(rdma_dev->engine_id), qpid));
  write32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_QPCONFi(rdma_dev->engine_id), qpid),
...
int destroy_rdma_qp(struct rdma_qp_t* qp) {
  ...
  if(qp != NULL) {
    ...
    rt_value = read32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATQPi(qp->rdma_dev->engine_id), qp->qpid));
    ...
    rt_value = read32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQHEADi(qp->rdma_dev->engine_id), qp->qpid));
    if (rt_value != read32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_SQPIi(qp->rdma_dev->engine_id), qp->qpid))) {
    ...
    rt_value = read32_data(qp->rdma_dev->axil_ctl, RN_RDMA_GCSR_XRNICADCONF(qp->rdma_dev->engine_id));
    write32_data(qp->rdma_dev->axil_ctl, RN_RDMA_GCSR_XRNICADCONF(qp->rdma_dev->engine_id), (rt_value | 0x00000001));
    rt_value = read32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_QPCONFi(qp->rdma_dev->engine_id), qp->qpid));
    write32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_QPCONFi(qp->rdma_dev->engine_id), qp->qpid),  (rt_value & 0xfffffffe));
    ...
    write32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_RQWPTRDBADDi(qp->rdma_dev->engine_id), qp->qpid), 0);
    write32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_SQPIi(qp->rdma_dev->engine_id), qp->qpid), 0);
    write32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQHEADi(qp->rdma_dev->engine_id), qp->qpid), 0);

    write32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_RQCIi(qp->rdma_dev->engine_id), qp->qpid), 0);
    write32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATRQPIDBi(qp->rdma_dev->engine_id), qp->qpid), 0);
    write32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATCURSQPTRi(qp->rdma_dev->engine_id), qp->qpid), 0);
    write32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_SQPSNi(qp->rdma_dev->engine_id), qp->qpid), 0);
    write32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_LSTRQREQi(qp->rdma_dev->engine_id), qp->qpid), 0);
    write32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATMSNi(qp->rdma_dev->engine_id), qp->qpid), 0);
    rt_value = read32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_QPCONFi(qp->rdma_dev->engine_id), qp->qpid));

    uint32_t test = read32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQHEADi(qp->rdma_dev->engine_id), qp->qpid));
    Debug("[DEBUG] Destroying dev: %p, RN_RDMA_QCSR_CQHEADi=0x%x, qpid=%d, value=0x%x\n", qp->rdma_dev->axil_ctl,
                            get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQHEADi(qp->rdma_dev->engine_id), qp->qpid), qp->qpid, test);

    write32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_QPCONFi(qp->rdma_dev->engine_id), qp->qpid),  (rt_value | 0x00000040));
    test = read32_data(qp->rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQHEADi(qp->rdma_dev->engine_id), qp->qpid));
    Debug("[DEBUG] Destroying dev: %p, RN_RDMA_QCSR_CQHEADi=0x%x, qpid=%d, value=0x%x\n", qp->rdma_dev->axil_ctl,
                            get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQHEADi(qp->rdma_dev->engine_id), qp->qpid), qp->qpid, test);

    // Disable software override mode (1'b0) in XRNICADCONF[0]
    rt_value = read32_data(qp->rdma_dev->axil_ctl, RN_RDMA_GCSR_XRNICADCONF(qp->rdma_dev->engine_id));
    write32_data(qp->rdma_dev->axil_ctl, RN_RDMA_GCSR_XRNICADCONF(qp->rdma_dev->engine_id), (rt_value & 0xfffffffe));
...
void dump_registers(struct rdma_dev_t* rdma_dev, uint8_t is_sender, uint32_t qpid) {
  ...
  fprintf(stderr, "Info: [RN_RDMA_GCSR_ERRBUFWPTR      = 0x%x] = 0x%x\n", RN_RDMA_GCSR_ERRBUFWPTR(rdma_dev->engine_id)     ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_ERRBUFWPTR(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_IPKTERRQWPTR    = 0x%x] = 0x%x\n", RN_RDMA_GCSR_IPKTERRQWPTR(rdma_dev->engine_id)   ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_IPKTERRQWPTR(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_INSRRPKTCNT     = 0x%x] = 0x%x\n", RN_RDMA_GCSR_INSRRPKTCNT(rdma_dev->engine_id)    ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_INSRRPKTCNT(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_INAMPKTCNT      = 0x%x] = 0x%x\n", RN_RDMA_GCSR_INAMPKTCNT(rdma_dev->engine_id)     ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_INAMPKTCNT(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_OUTIOPKTCNT     = 0x%x] = 0x%x\n", RN_RDMA_GCSR_OUTIOPKTCNT(rdma_dev->engine_id)    ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_OUTIOPKTCNT(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_OUTAMPKTCNT     = 0x%x] = 0x%x\n", RN_RDMA_GCSR_OUTAMPKTCNT(rdma_dev->engine_id)    ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_OUTAMPKTCNT(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_LSTINPKT        = 0x%x] = 0x%x\n", RN_RDMA_GCSR_LSTINPKT(rdma_dev->engine_id)       ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_LSTINPKT(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_LSTOUTPKT       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_LSTOUTPKT(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_LSTOUTPKT(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_ININVDUPCNT     = 0x%x] = 0x%x\n", RN_RDMA_GCSR_ININVDUPCNT(rdma_dev->engine_id)    ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_ININVDUPCNT(rdma_dev->engine_id)));
  //fprintf(stderr, "Info: [RN_RDMA_GCSR_INNCKPKTSTS     = 0x%x] = 0x%x\n", RN_RDMA_GCSR_INNCKPKTSTS(rdma_dev->engine_id)    ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_INNCKPKTSTS(rdma_dev->engine_id)));
  //fprintf(stderr, "Info: [RN_RDMA_GCSR_OUTRNRPKTSTS    = 0x%x] = 0x%x\n", RN_RDMA_GCSR_OUTRNRPKTSTS(rdma_dev->engine_id)   ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_OUTRNRPKTSTS(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_WQEPROCSTS      = 0x%x] = 0x%x\n", RN_RDMA_GCSR_WQEPROCSTS(rdma_dev->engine_id)     ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_WQEPROCSTS(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_QPMSTS          = 0x%x] = 0x%x\n", RN_RDMA_GCSR_QPMSTS(rdma_dev->engine_id)         ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_QPMSTS(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_INALLDRPPKTCNT  = 0x%x] = 0x%x\n", RN_RDMA_GCSR_INALLDRPPKTCNT(rdma_dev->engine_id) ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_INALLDRPPKTCNT(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_INNAKPKTCNT     = 0x%x] = 0x%x\n", RN_RDMA_GCSR_INNAKPKTCNT(rdma_dev->engine_id)    ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_INNAKPKTCNT(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_OUTNAKPKTCNT    = 0x%x] = 0x%x\n", RN_RDMA_GCSR_OUTNAKPKTCNT(rdma_dev->engine_id)   ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_OUTNAKPKTCNT(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_RESPHNDSTS      = 0x%x] = 0x%x\n", RN_RDMA_GCSR_RESPHNDSTS(rdma_dev->engine_id)     ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_RESPHNDSTS(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_RETRYCNTSTS     = 0x%x] = 0x%x\n", RN_RDMA_GCSR_RETRYCNTSTS(rdma_dev->engine_id)    ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_RETRYCNTSTS(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_INCNPPKTCNT     = 0x%x] = 0x%x\n", RN_RDMA_GCSR_INCNPPKTCNT(rdma_dev->engine_id)    ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_INCNPPKTCNT(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_OUTCNPPKTCNT    = 0x%x] = 0x%x\n", RN_RDMA_GCSR_OUTCNPPKTCNT(rdma_dev->engine_id)   ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_OUTCNPPKTCNT(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_OUTRDRSPPKTCNT  = 0x%x] = 0x%x\n", RN_RDMA_GCSR_OUTRDRSPPKTCNT(rdma_dev->engine_id) ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_OUTRDRSPPKTCNT(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_INTSTS          = 0x%x] = 0x%x\n", RN_RDMA_GCSR_INTSTS(rdma_dev->engine_id)         ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_INTSTS(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_RQINTSTS1       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_RQINTSTS1(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_RQINTSTS1(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_RQINTSTS2       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_RQINTSTS2(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_RQINTSTS2(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_RQINTSTS3       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_RQINTSTS3(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_RQINTSTS3(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_RQINTSTS4       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_RQINTSTS4(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_RQINTSTS4(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_RQINTSTS5       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_RQINTSTS5(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_RQINTSTS5(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_RQINTSTS6       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_RQINTSTS6(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_RQINTSTS6(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_RQINTSTS7       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_RQINTSTS7(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_RQINTSTS7(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_RQINTSTS8       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_RQINTSTS8(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_RQINTSTS8(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_CQINTSTS1       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_CQINTSTS1(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_CQINTSTS1(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_CQINTSTS2       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_CQINTSTS2(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_CQINTSTS2(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_CQINTSTS3       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_CQINTSTS3(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_CQINTSTS3(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_CQINTSTS4       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_CQINTSTS4(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_CQINTSTS4(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_CQINTSTS5       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_CQINTSTS5(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_CQINTSTS5(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_CQINTSTS6       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_CQINTSTS6(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_CQINTSTS6(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_CQINTSTS7       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_CQINTSTS7(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_CQINTSTS7(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_GCSR_CQINTSTS8       = 0x%x] = 0x%x\n", RN_RDMA_GCSR_CQINTSTS8(rdma_dev->engine_id)      ,read32_data(rdma_dev->axil_ctl, RN_RDMA_GCSR_CQINTSTS8(rdma_dev->engine_id)));
  fprintf(stderr, "Info: [RN_RDMA_QCSR_CQHEADi         = 0x%x] = 0x%x\n", get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQHEADi(rdma_dev->engine_id), qpid), read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_CQHEADi(rdma_dev->engine_id), qpid)));
  fprintf(stderr, "Info: [RN_RDMA_QCSR_STATSSNi        = 0x%x] = 0x%x\n", get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATSSNi(rdma_dev->engine_id), qpid), read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATSSNi(rdma_dev->engine_id), qpid)));
  fprintf(stderr, "Info: [RN_RDMA_QCSR_STATMSNi        = 0x%x] = 0x%x\n", get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATMSNi(rdma_dev->engine_id), qpid), read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATMSNi(rdma_dev->engine_id), qpid)));
  fprintf(stderr, "Info: [RN_RDMA_QCSR_STATQPi         = 0x%x] = 0x%x\n", get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATQPi(rdma_dev->engine_id), qpid), read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATQPi(rdma_dev->engine_id), qpid)));
  fprintf(stderr, "Info: [RN_RDMA_QCSR_STATCURSQPTRi   = 0x%x] = 0x%x\n", get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATCURSQPTRi(rdma_dev->engine_id), qpid), read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATCURSQPTRi(rdma_dev->engine_id), qpid)));
  fprintf(stderr, "Info: [RN_RDMA_QCSR_STATRESPSNi     = 0x%x] = 0x%x\n", get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATRESPSNi(rdma_dev->engine_id), qpid), read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATRESPSNi(rdma_dev->engine_id), qpid)));
  fprintf(stderr, "Info: [RN_RDMA_QCSR_STATRQBUFCAi    = 0x%x] = 0x%x\n", get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATRQBUFCAi(rdma_dev->engine_id), qpid), read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATRQBUFCAi(rdma_dev->engine_id), qpid)));
  fprintf(stderr, "Info: [RN_RDMA_QCSR_STATWQEi        = 0x%x] = 0x%x\n", get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATWQEi(rdma_dev->engine_id), qpid), read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATWQEi(rdma_dev->engine_id), qpid)));
  fprintf(stderr, "Info: [RN_RDMA_QCSR_STATRQPIDBi     = 0x%x] = 0x%x\n", get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATRQPIDBi(rdma_dev->engine_id), qpid), read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATRQPIDBi(rdma_dev->engine_id), qpid)));
  fprintf(stderr, "Info: [RN_RDMA_QCSR_STATRQBUFCAMSBi = 0x%x] = 0x%x\n", get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATRQBUFCAMSBi(rdma_dev->engine_id), qpid), read32_data(rdma_dev->axil_ctl, get_rdma_per_q_config_addr(RN_RDMA_QCSR_STATRQBUFCAMSBi(rdma_dev->engine_id), qpid)));
