...
# Programming options
#   prog_file  : A file in *.mcs used to program FPGA
...
set mcs_file $prog_file

puts "Programming file: $mcs_file"
...
current_hw_device [get_hw_devices $hw_device_id]
    ...
    set_property PROGRAM.FILES [list "$mcs_file" ] [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices $hw_device_id] 0]]
