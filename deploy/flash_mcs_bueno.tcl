...
open_hw_target {localhost:3121/xilinx_tcf/Xilinx/XFL1IAEL2T33A}
...
cd /work/amotta/bitstream_u55c

write_cfgmem -force -format mcs -interface spix4 -size 128 -loadbit "up 0x01002000 ace_rv_qdma_final.bit" -file "u55.mcs"

set_property PROGRAM.ADDRESS_RANGE  {use_file} [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xcu280_u55c_0] 0]]
set_property PROGRAM.FILES [list "u55.mcs" ] [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xcu280_u55c_0] 0]]
...
set_property PROGRAM.PRM_FILES [list "u55.prm" ] [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xcu280_u55c_0] 0]]
