...
set_property -dict {
    ...
    CONFIG.S07_WRITE_ACCEPTANCE {8}
    CONFIG.S08_WRITE_ACCEPTANCE {8}
    CONFIG.S09_WRITE_ACCEPTANCE {8}
    ...
    CONFIG.S07_READ_ACCEPTANCE {8}
    CONFIG.S08_READ_ACCEPTANCE {8}
    CONFIG.S09_READ_ACCEPTANCE {8}
