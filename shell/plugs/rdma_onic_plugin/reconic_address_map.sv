...
// ----------------------------------------------------------
//   0x4000   |  0x4FFF   |  Table control 1
// ----------------------------------------------------------
//   0x5000   |  0x5FFF   |  RecoNIC Shell Registers 1
// ----------------------------------------------------------
//   0x6000   |  0x6FFF   |  Compute Logic Registers 1
// ----------------------------------------------------------
`timescale 1ns/1ps
...
// TODO: Check if the range (4000-7000) is OK or if it is overlapped with other modules
localparam C_RECONIC_BASE_ADDR = (RECONIC_ID == 0) ? 32'h0 : 32'h4000;

localparam C_CTRL_BASE_ADDR   = C_RECONIC_BASE_ADDR + 32'h0;
localparam C_RN_REG_BASE_ADDR = C_RECONIC_BASE_ADDR + 32'h2000;
localparam C_CL_REG_BASE_ADDR = C_RECONIC_BASE_ADDR + 32'h3000;
