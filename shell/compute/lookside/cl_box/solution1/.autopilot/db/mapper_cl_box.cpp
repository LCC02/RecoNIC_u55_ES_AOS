...
auto* sctl_cmd_stream = createStream((hls::stream<int>*)__xlx_apatb_param_ctl_cmd_stream);
  // DUT call
  cl_box(sctl_cmd_stream->data<int>(), __xlx_apatb_param_a_baseaddr, __xlx_apatb_param_b_baseaddr, __xlx_apatb_param_c_baseaddr, __xlx_apatb_param_a_row, __xlx_apatb_param_a_col, __xlx_apatb_param_b_col, __xlx_apatb_param_work_id);
sctl_cmd_stream->transfer((hls::stream<int>*)__xlx_apatb_param_ctl_cmd_stream);
}
