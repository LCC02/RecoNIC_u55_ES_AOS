...
extern "C"
void cl_box_hw_stub_wrapper(void*, void*, void*, void*, void*, void*, void*, void*);

extern "C"
void apatb_cl_box_hw(void* __xlx_apatb_param_ctl_cmd_stream, void* __xlx_apatb_param_a_baseaddr, void* __xlx_apatb_param_b_baseaddr, void* __xlx_apatb_param_c_baseaddr, void* __xlx_apatb_param_a_row, void* __xlx_apatb_param_a_col, void* __xlx_apatb_param_b_col, void* __xlx_apatb_param_work_id)
{
  static hls::sim::Stream<hls::sim::Byte<4>> port0 {
    .width = 32,
    .name = "ctl_cmd_stream",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_ctl_cmd_stream),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_ctl_cmd_stream),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_ctl_cmd_stream),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_ctl_cmd_stream),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_ctl_cmd_stream;
  ...
  static hls::sim::Register port1 {
    ...
    .width = 32,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_a_baseaddr),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_a_baseaddr),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_a_baseaddr),
#endif
  };
  port1.param = __xlx_apatb_param_a_baseaddr;

  static hls::sim::Register port2 {
    .name = "b_baseaddr",
    .width = 32,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_b_baseaddr),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_b_baseaddr),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_b_baseaddr),
#endif
  };
  port2.param = __xlx_apatb_param_b_baseaddr;

  static hls::sim::Register port3 {
    .name = "c_baseaddr",
    .width = 32,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_c_baseaddr),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_c_baseaddr),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_c_baseaddr),
#endif
  };
  port3.param = __xlx_apatb_param_c_baseaddr;

  static hls::sim::Register port4 {
    .name = "a_row",
    .width = 32,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_a_row),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_a_row),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_a_row),
#endif
  };
  port4.param = __xlx_apatb_param_a_row;

  static hls::sim::Register port5 {
    .name = "a_col",
    .width = 32,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_a_col),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_a_col),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_a_col),
#endif
  };
  port5.param = __xlx_apatb_param_a_col;

  static hls::sim::Register port6 {
    .name = "b_col",
    .width = 32,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_b_col),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_b_col),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_b_col),
#endif
  };
  port6.param = __xlx_apatb_param_b_col;

  static hls::sim::Register port7 {
    .name = "work_id",
    .width = 32,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_work_id),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_work_id),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_work_id),
#endif
  };
  port7.param = __xlx_apatb_param_work_id;
