...
extern "C" void mmult(Byte<64>*, int*, int, int, int, int, int, int, int);
...
auto* swork_id_out_stream = createStream((hls::stream<int>*)__xlx_apatb_param_work_id_out_stream);
  // DUT call
  mmult(__xlx_a_b_c__tmp_vec.data(), swork_id_out_stream->data<int>(), __xlx_offset_byte_param_a, __xlx_offset_byte_param_b, __xlx_offset_byte_param_c, __xlx_apatb_param_a_row, __xlx_apatb_param_a_col, __xlx_apatb_param_b_col, __xlx_apatb_param_work_id);
...
swork_id_out_stream->transfer((hls::stream<int>*)__xlx_apatb_param_work_id_out_stream);
}
