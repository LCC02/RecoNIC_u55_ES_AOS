...
extern "C"
void mmult_hw_stub_wrapper(void*, void*, void*, void*, hls::sim::Byte<4>, hls::sim::Byte<4>, hls::sim::Byte<4>, hls::sim::Byte<4>);

extern "C"
void apatb_mmult_hw(void* __xlx_apatb_param_work_id_out_stream, void* __xlx_apatb_param_a, void* __xlx_apatb_param_b, void* __xlx_apatb_param_c, hls::sim::Byte<4> __xlx_apatb_param_a_row, hls::sim::Byte<4> __xlx_apatb_param_a_col, hls::sim::Byte<4> __xlx_apatb_param_b_col, hls::sim::Byte<4> __xlx_apatb_param_work_id)
{
  static hls::sim::Stream<hls::sim::Byte<4>> port0 {
    .width = 32,
    .name = "work_id_out_stream",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_work_id_out_stream),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_work_id_out_stream),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_work_id_out_stream),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_work_id_out_stream),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_work_id_out_stream;
  port0.hasWrite = true;
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_systolic),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_systolic),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_systolic),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_systolic),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_systolic),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_systolic),
#endif
#endif
    .hasWrite = { true, true, true },
  };
  port8.param = { __xlx_apatb_param_a, __xlx_apatb_param_b, __xlx_apatb_param_c };
  port8.mname = { "a", "b", "c" };
  port8.nbytes = { 0, 0, 0 };
  for (size_t off = 0, i = 0; i < port8.nbytes.size(); ++i) {
    port8.offset.push_back(off);
    off += hls::sim::divide_ceil(port8.nbytes[i], port8.asize);
  }
  __xlx_offset_byte_param_a = port8.offset[0]*64;
  __xlx_offset_byte_param_b = port8.offset[1]*64;
  __xlx_offset_byte_param_c = port8.offset[2]*64;
